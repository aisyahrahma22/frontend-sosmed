...
function ResetPassword() {
  ...
  let [inputValues, setInputValues] = useState({ newPassword: "" });
  ...
  const validateInfo = (values) => {
    ...
    } else if (!/\S+@\S+\.\S+/.test(values. newPassword)) {
      errors. newPassword = " New Password is invalid";
    }
        ...
        >
          <div className="mb-3 d-flex flex-column">
            ...
            <input
              id="form-email"
              type="text"
              className={`form-control ${errors.newPassword ? `is-invalid` : null}`}
